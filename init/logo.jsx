/**
 * Created by VickyWang on 2018/6/20
 */
...
class LogoGather extends React.Component {
    ...
    createPointData = () => {
        ...
        // setTimeout(this.onMouseLeave(),1200)
        // setTimeout(this.onMouseEnter(),1800)
    ...
    render() {
        return (
            <div className="logo-gather-demo-wrapper" id="logo-div" style={{zIndex:9999999999999999,}}>
                <canvas id="canvas"/>
                <TweenOne
